...
Create public URLs via Tailscale Funnel to access services on your host machine from anywhere on the internet. Supports multiple tunnels in parallel — ideal for home server setups.
...
Output will display public URLs, for example:
...
Grafana       → port 3000 (on another machine)
Syncthing     → port 8384
```
